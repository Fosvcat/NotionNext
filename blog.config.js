...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Fosvcat', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.fosvcat.top', // 网站地址
    KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,Fosvcat,Fosvcat-blog,Fosvcat博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
    CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'fosvcat@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
    CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/fosvcat', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备2022007944号', // 备案号 闽ICP备XXXXXXX
  ...
  QR_CODE_CDN:
    ...
    BACKGROUND_LIGHT: '#f0f1f3', // use hex value, don't forget '#' e.g #fffefc
    BACKGROUND_DARK: '#2a3441', // use hex value, don't forget '#'
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,email,twitter,telegram,messenger,line,whatsapp,qq', // 分享的服務，按顺序显示,逗号隔开
  ...
  // 微软 Clarity 站点分析
    CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'll2psqktod', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-5936907770820775', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  ADSENSE_GOOGLE_SLOT_AUTO: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '5476777987', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
  ...
  // END<----营收相关
    ...
    NOTION_PROPERTY_NAME: {
        ...
        status: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS || '状态', //状态
        status_publish: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_PUBLISH || '发布', // 当status状态值与此相同时为发布，可以为中文
        status_invisible: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_INVISIBLE || '隐藏', // 当status状态值与此相同时为隐藏发布，可以为中文 ， 除此之外其他页面状态不会显示在博客上
        summary: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SUMMARY || '描述', //摘要
        slug: process.env.NEXT_PUBLIC_NOTION_PROPERTY_SLUG || '链接', //链接
        category: process.env.NEXT_PUBLIC_NOTION_PROPERTY_CATEGORY || '分类', //分类
        date: process.env.NEXT_PUBLIC_NOTION_PROPERTY_DATE || '日期', //日期
        tags: process.env.NEXT_PUBLIC_NOTION_PROPERTY_TAGS || '标签', //标签
        icon: process.env.NEXT_PUBLIC_NOTION_PROPERTY_ICON || '图标', //图标
